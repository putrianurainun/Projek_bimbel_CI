...
<div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('<?php echo base_url(); ?>/akademik/images/bg_1.jpg')">
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <img src="<?php echo base_url(); ?>/akademik/images/course_4.jpg" alt="Image" class="img-fluid"> 
                </div>
    ...
    <div class="section-bg style-1" style="background-image: url('<?php echo base_url(); ?>/akademik/images/hero_1.jpg');">
        <div class="container">
          <div class="row">

      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            	<a href="/pelajaran/create">Tambah</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                  	<a href="pelajaran/edit/<?php echo $data['id_pelajaran'] ?>" class="btn btn-warning">Edit</a>
					<form action="/pelajaran/delete/ <?php 	echo $data['id_pelajaran'] ?>" method='post' class='id-inline'>	

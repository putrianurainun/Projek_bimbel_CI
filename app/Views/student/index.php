            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img src="/image/<?php echo $data['foto_student']; ?>"></td>
                  <td><?php echo $data['jk_student']; ?></td>
                  <td><?php echo $data['alamat_student']; ?></td>
                  <td><?php echo $data['no_hp']; ?></td>
                  <td><?php echo $data['email_student']; ?></td>
                  <td>
                  	<a href="student/edit/<?php echo $data['id_student'] ?>" class="btn btn-warning">Edit</a>
					<form action="/student/delete/ <?php 	echo $data['id_student'] ?>" method='post' class='id-inline'>	
